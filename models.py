...
class ClientData(BaseModel):
    ...
    total_limit_gb: float = 50.0  # سقف ترافیک بر حسب گیگ
    used_gb: float = 0.0  # ترافیک مصرف شده
    expiry_days: int = 30  # تعداد روز اعتبار
    created_at: str  # تاریخ ایجاد
    last_reset: str = ""  # آخرین تاریخ ریست
    status: str = "active"  # active, ended, offline, disabled
    ...
    def generate_vless_link(self, host: str) -> str:
        ...
        return generate_vless_link(self.uuid, host, remark=self.username)
